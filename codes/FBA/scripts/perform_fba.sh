...
pt=( ASD_PRS_Pt_001 ASD_PRS_Pt_1em08 ASD_PRS_Pt_1em06 ASD_PRS_Pt_1em5 ASD_PRS_Pt_00001 ASD_PRS_Pt_0001 ASD_PRS_Pt_005 ASD_PRS_Pt_01 ASD_PRS_Pt_05 ASD_PRS_Pt_all ASD_PRS_PC1 )
for fba_measure in ${fba_measures_to_examine[@]}; do
    for threshold in ${pt[@]}; do
	if [ ! -d "$fba_output/$threshold" ]; then

...
#run 'Generating tissue maps from 40 weeks template' \
#	mrconvert IN:$Tissue_segmented_probseg OUT:csf_template.mif \
#	OUT:$gm OUT:wm_template.mif OUT:skull_template.mif \
#	OUT:vent_template.mif OUT:cerr_template.mif \
#	OUT:dgm_template.mif OUT:stem_template.mif
#

#run 'Generating tissue maps from 40 weeks template' \
#	mrconvert IN:$Tissue_segmented_probseg OUT:p-[].mif
...
run 'Generating 5TT file' \
	mrcat IN:$gm IN:$dgm IN:$wm IN:$csf IN:$path -axis 3 - \| mrcalc - 100 -div OUT:$image_5TT

...
run 'generating an average image of 40 weeks masks' \
	mrmath $(IN $subject_masks) min -datatype bit - \| mrgrid - regrid -voxel 1.3 -interp nearest OUT:$warped_mask_average

run 'generating an average image of 40 weeks FODs' \
	mrmath $(IN $subject_fods) mean - \| mrgrid - regrid -voxel 1.3 -interp sinc OUT:$warped_wm_fod_average
